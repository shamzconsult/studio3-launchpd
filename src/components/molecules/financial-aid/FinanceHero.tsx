  ...
  return (
    <div className="w-full lg:py-20  px-4 lg:px-0">
      <section className="max-w-6xl bg-[#851711] rounded-lg  mx-auto   flex flex-col  lg:flex-row justify-between lg:items-center mt-32 w-full  ">
        <div className="max-w-xl  text-[#FAFAFA] lg:w-1/2 h-inherit p-4 md:p-6 rounded-l">
          <h1 className="text-[20px]  md:text-[32px] font-extrabold leading-normal md:leading-[40px] mb-4">
        ...
        <div className="relative w-full h-[300px] md:h-[400px] lg:w-1/2 ">
          <Image
