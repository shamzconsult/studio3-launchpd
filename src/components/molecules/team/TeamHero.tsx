...
export const TeamHero = () => {
  return (
    <div className="max-w-6xl mx-auto  px-4 lg:px-0 py-20 mt-10 lg:mt-20">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-3 lg:gap-14">
        <h1 className="text-2xl md:text-4xl  leading-normal md:leading-relaxed lg:leading-[60px]  font-bold mb-4">
